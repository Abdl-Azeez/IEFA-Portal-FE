  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p
          className="text-xs font-medium tracking-wide uppercase mb-1.5"
          style={{ color: "#667085" }}
        >
          {label}
        </p>
      ...
      <div className="flex items-center justify-between flex-wrap gap-3 mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm leading-tight" style={{ color: "#667085" }}>
              {subtitle}
            </p>
          </div>
        </div>
...
function SectionCard({
  ...
  return (
    <div
      className={`bg-white border rounded-xl p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)] ${className}`}
      style={{ borderColor: "#E9E5E5" }}
      role="region"
      aria-label={title}
    >
      <p className="text-sm font-semibold mb-4" style={{ color: "#667085" }}>
        {title}
      </p>
      ...
      {hasContent ? (
        ...
        <p className="py-8 text-center text-xs" style={{ color: "#98A2B3" }}>
...
function AnimatedMetricNumber({
  ...
  return (
    <span className={className}>{`${count.toLocaleString()}${suffix}`}</span>
  );
}
...
function GlobalGlanceCountryTooltip({
  ...
  const match = ISLAMIC_DATA.globalGlance.topCountriesByAssets.find(
...
function SectorBreakdownRow({
  ...
  useEffect(() => {
    const timer = setTimeout(
      () => setProgressWidth(sector.sharePercent),
      index * 100,
    );
    return () => clearTimeout(timer);
          ...
          >
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              >
                ...
                <div className="mt-1 text-sm text-gray-700">
                  {isLeader
                    ? "Largest sector by assets"
                    : `${relativeToLeader}% of the leader sector size`}
                </div>
...
function TakafulMarketCard({
  ...
  return (
    ...
    >
      ...
      <p className="min-h-[68px] text-xs leading-relaxed text-gray-500">
        {market.description}
      </p>
      <div
        className={`mt-4 inline-flex rounded-full border px-2.5 py-1 text-[11px] ${market.statusClassName}`}
      >
        {market.status}
      </div>
    </div>
...
function OifiGrowthTooltip({
  ...
  payload?: Array<{
    value?: number | null;
    payload?: { year?: string; projected?: boolean };
  }>;
  label?: string;
}>) {
  if (!active || !payload?.length) {
  ...
  const isDipYear =
    item.payload?.year === "2021" || item.payload?.year === "2022";
  ...
  return (
    ...
    >
      ...
      <div>{formatUsdValue(item.value)}</div>
      {isDipYear && (
        <div className="mt-1 italic" style={{ color: "#98A2B3" }}>
          (Post-COVID market adjustment)
        </div>
      )}
      {item.payload?.projected && (
        <div className="mt-2">
...
function EcosystemMetricRow({
  ...
  return (
    <div
      className="flex items-center justify-between gap-3 py-2 last:border-b-0 last:pb-0 first:pt-0"
      style={{ borderBottom: "1px solid #E9E5E5" }}
    >
...
function IFDIRankCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-3 text-sm font-semibold text-gray-900">
        {country}
      </div>
...
function TabGlobalGlance() {
  ...
  const assetsGrowthData = globalGlance.assetsGrowth.map(
    (item, index, array) => {
      ...
      return {
        ...
        projectedValue:
          item.projected || item.year === "2024" ? item.value : null,
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        >
          <div
            className="absolute right-5 top-5 rounded-full px-2 py-1 text-xs"
            style={{ backgroundColor: `${COLORS.teal}10`, color: COLORS.teal }}
          >
            ...
            <ResponsiveContainer width="100%" height="100%" minWidth={0}>
              ...
              >
                ...
                <ReferenceLine
                  ...
                  strokeDasharray="4 2"
                  label={{
                    value: globalGlance.highlights.milestoneLabel,
      ...
      <SectionCard title="Top 10 Countries by Total Islamic Finance Assets (US$bn, 2024)">
        <div className="mb-4 flex flex-wrap gap-2">
          <span
            ...
            style={{ backgroundColor: `${COLORS.teal}10`, color: COLORS.teal }}
          >
            🥇 {globalGlance.highlights.leadingCountry} leads at{" "}
            {formatUsdValue(globalGlance.highlights.leadingCountryValue)}
          </span>
          <span
            className="rounded-full px-3 py-1 text-xs"
            style={{
          ...
          >
            🌍 Top 3 = {globalGlance.highlights.topThreeSharePercent}% of global
            assets
          </span>
          <span
            className="rounded-full px-3 py-1 text-xs"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                <RadialBarChart
                  data={[
                    {
                      name: "Disclosure",
                      value: governanceDisclosure?.value ?? 0,
                      fill: COLORS.teal,
                    },
                  ]}
                  startAngle={180}
        ...
        <SectionCard title="🌱 Sustainability" className="">
          ...
          <div className="space-y-2">
            {globalGlance.ecosystem.sustainability.map((metric) => (
              <div
                key={metric.label}
                className="flex items-center justify-between gap-3 border-b border-gray-200 py-2 last:border-b-0 last:pb-0 first:pt-0"
              >
          ...
          <div className="mt-4 border-t border-gray-200 pt-4">
            <div className="mb-2 text-xs text-gray-500">
              {globalGlance.ecosystem.sustainability[2].value} countries have
            ...
            <div className="h-2 overflow-hidden rounded-full bg-gray-100">
              <div
                ...
                style={{
                  ...
                  width: `${(globalGlance.ecosystem.sustainability[2].raw / globalGlance.headline.countriesCovered) * 100}%`,
                }}
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            {(() => {
              const maxAwareness = Math.max(
                ...globalGlance.ecosystem.awareness.map((m) => m.value),
              );
        ...
        <SectionCard title="🎓 Knowledge" className="">
          ...
          <div className="space-y-3">
            {(() => {
              const maxKnowledge = Math.max(
                ...globalGlance.ecosystem.knowledge.map((m) => m.value),
              );
          ...
          <div className="mt-4 text-xs italic text-gray-400">
            {globalGlance.ecosystem.knowledgeLeader.country} leads with{" "}
            {globalGlance.ecosystem.knowledgeLeader.providers.toLocaleString()}{" "}
            IF education providers
          </div>
        </SectionCard>
      </div>
      ...
      <div className="text-center text-xs text-gray-400">
        ...
        {globalGlance.highlights.sourceNote} | All values in US$ billions unless
        noted
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <SectionCard title="Islamic Finance Industry Breakdown by Sector (2024)">
        {(() => {
          const maxSectorShare = Math.max(
            ...globalOverview.sectorBreakdown.map((item) => item.sharePercent),
          );
            ...
            <SectorBreakdownRow
              ...
              onToggle={() =>
                setExpandedSector((current) =>
                  current === sector.sector ? null : sector.sector,
                )
              }
            />
          ));
        ...
        >
          <div className="flex flex-col gap-4 font-semibold lg:flex-row lg:items-center">
            ...
            <div className="w-full lg:w-1/6 text-lg font-bold">
              {globalOverview.headline.totalAssetsExact}
            </div>
            <div className="w-full lg:w-2/5">
              <div className="flex items-center gap-3">
                <div className="h-2 flex-1 overflow-hidden rounded-full bg-white">
            ...
            <div className="w-full lg:w-1/5">
              {globalOverview.headline.totalInstitutions.toLocaleString()} IFIs
            </div>
          </div>
        </div>
      </SectionCard>
          ...
          <div className="space-y-5">
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
              <CircularProgressRing
                value={
                  globalOverview.institutionBreakdown.fullyFledged.shareOfAssets
                }
                color={COLORS.teal}
                label="of IFI Assets"
              />
              <div
                ...
                style={{ color: COLORS.teal }}
              >
                {globalOverview.institutionBreakdown.fullyFledged.count.toLocaleString()}{" "}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="rounded-full border border-gray-200 px-2 py-0.5 text-xs uppercase tracking-[0.2em] text-gray-400">
                vs
              </div>
              <div className="h-px flex-1 bg-gray-100" />
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
              <CircularProgressRing
                value={
                  globalOverview.institutionBreakdown.windows.shareOfAssets
                }
                color={COLORS.ocean}
                label="of IFI Assets"
              />
              ...
              >
                {globalOverview.institutionBreakdown.windows.count.toLocaleString()}{" "}
                Islamic Banking Windows
              </div>
            </div>

            <div className="rounded-xl bg-gray-100 p-3 text-xs italic text-gray-500">
              💡 Fully-fledged institutions hold nearly{" "}
              {Math.round(
                globalOverview.institutionBreakdown.fullyFledged.shareOfAssets /
                  globalOverview.institutionBreakdown.fullyFledged.count /
                  (globalOverview.institutionBreakdown.windows.shareOfAssets /
                    globalOverview.institutionBreakdown.windows.count),
              )}
              × more assets per institution than Islamic banking windows
            </div>
          </div>
        </SectionCard>
      ...
      <SectionCard title="Regional Islamic Finance Asset Share">
        <div className="relative">
          ...
          >
            🌍 OIC Countries represent{" "}
            {globalOverview.headline.oicCountriesAssetShare}% of total global
      ...
      <div className="text-center text-xs text-gray-400">
        Source: ICD-LSEG Islamic Finance Development Report 2025 | Data covers
        global IF structure across all major regions | All values in US$
...
function TabIslamicBanking() {
  ...
  const actualGrowth = islamicBanking.assetsGrowth.filter(
    (item) => !item.projected,
  );
  ...
  const topTwoAssets =
    islamicBanking.topCountries[0].value + islamicBanking.topCountries[1].value;
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-wrap gap-3">
        <BankingInsightPill
          className="border-[#0F9D8A]/20 bg-[#0F9D8A]/8 text-[#0F9D8A]"
          delay={800}
        >
          🏦 Islamic banking = {islamicBanking.headline.globalBankingShare} of
          global banking assets
        </BankingInsightPill>
        <BankingInsightPill
          className="border-[#D4A017]/20 bg-[#D4A017]/8 text-[#D4A017]"
          delay={900}
        >
          📍 Sub-Saharan Africa: {islamicBanking.headline.subSaharanAfricaBanks}{" "}
          banks across {islamicBanking.headline.subSaharanAfricaCountries}{" "}
          countries
        </BankingInsightPill>
        <BankingInsightPill
          className="border-[#16A34A]/20 bg-[#16A34A]/8 text-[#16A34A]"
          delay={1000}
        >
          🔀 Windows account for {islamicBanking.headline.windowsBankShare} of
          banks but only {islamicBanking.headline.windowsAssetShare} of assets
        </BankingInsightPill>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <SectionCard
          title="Islamic Banking Asset Growth (2018 → 2029 Projected)"
          className="lg:col-span-3"
        >
          <div className="h-[340px]">
            <ResponsiveContainer width="100%" height="100%" minWidth={0}>
              <ComposedChart
                data={composedGrowthData}
        ...
        >
          ...
          <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2">
            ...
            >
              MENA dominates:{" "}
              {formatUsdValue(islamicBanking.headline.menaDominanceValue)} (
              {islamicBanking.headline.menaDominanceShare})
            </div>
            <div
              className="rounded-xl border p-3 text-xs"
              style={{
      ...
      <SectionCard title="Top 10 Countries by Islamic Banking Assets (US$bn, 2024)">
        ...
        <div className="mt-4 rounded-xl border border-gray-200 bg-gray-100 p-4 text-xs leading-relaxed text-gray-500">
          💡 Key Insight: Iran and Saudi Arabia alone account for{" "}
          {formatUsdValue(topTwoAssets)} — 68% of total Islamic banking assets
          globally. Malaysia leads Southeast Asia with{" "}
          {formatUsdValue(islamicBanking.topCountries[2].value)} while Indonesia
          shows strong growth momentum.
        </div>
      </SectionCard>
      ...
      <SectionCard title="Islamic Banking Asset Growth Journey — US$1.685tn to US$4.32tn in 6 Years">
        <div className="mb-3 flex items-center justify-between text-xs">
          <span className="text-gray-500">
            2018: {formatUsdValue(timelineData[0].value)}
          </span>
          <span className="text-gray-400">→</span>
          <span className="font-bold" style={{ color: COLORS.teal }}>
            2024: {formatUsdValue(timelineData[timelineData.length - 1].value)}{" "}
            (+156%)
          </span>
        </div>
        ...
        <div
          className="mt-2 border-t pt-2 text-center text-xs"
          style={{ borderColor: `${COLORS.gold}20`, color: COLORS.gold }}
        >
          2029 Projection:{" "}
          {formatUsdValue(
            islamicBanking.assetsGrowth[islamicBanking.assetsGrowth.length - 1]
              .value,
          )}{" "}
          (CAGR ~8%)
        </div>
      ...
      <div className="text-center text-xs text-gray-400">
        Source: ICD-LSEG Islamic Finance Development Report 2025 | Islamic
        banking data covers 84 markets globally | All values in US$ billions
        unless noted
      </div>
    </div>
  );
...
function TabTakaful() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div
        className="animate-in slide-in-from-top-3 duration-500 rounded-xl border p-4"
        style={{
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm font-semibold">
              🚀 Takaful is the fastest growing sector in Islamic finance —{" "}
              {takaful.headline.growth} growth in 2024, projecting{" "}
              {takaful.headline.projectedAssets2029} by 2029
            </div>
          </div>
          <div className="hidden items-end gap-1 sm:flex">
            <span
              className="h-3 w-2 rounded-t"
              style={{ backgroundColor: `${COLORS.gold}60` }}
            />
            <span
              className="h-5 w-2 rounded-t"
              style={{ backgroundColor: `${COLORS.gold}90` }}
            />
            <span
              className="h-7 w-2 rounded-t"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <SectionCard
          title="Takaful Assets Growth (2018–2029)"
          className="lg:col-span-3"
        >
          <div className="h-[320px]">
            <ResponsiveContainer width="100%" height="100%" minWidth={0}>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            >
              {takaful.headline.growthSince2018Multiple} growth since 2018
              (US$45bn → US$136bn)
            </span>
            <span
              className="rounded-full px-3 py-1 text-xs"
      ...
      <SectionCard title="Top 10 Countries by Takaful Assets (US$bn, 2024)">
            ...
            >
              ...
              {(index === 1 || index === 2) && (
                <div
                  ...
                  style={{ color: COLORS.gold }}
                >
                  Top 3 markets account for {takaful.headline.topThreeShare} of
                  Takaful assets
                </div>
              )}
            </div>
        ...
        <div className="mt-4 rounded-xl border border-amber-200 bg-gray-100 p-4 text-xs leading-relaxed text-gray-500">
          💡 Takaful operators are present in {takaful.headline.activeCountries}{" "}
          countries. New markets joining in 2024-2025 include Uganda,
          Philippines, and potentially Australia. GCC consolidation is ongoing
          with multiple merger discussions in Saudi Arabia and UAE.
        </div>
      </SectionCard>
      ...
      <div className="text-center text-xs text-gray-400">
        Source: ICD-LSEG Islamic Finance Development Report 2025 | Takaful data
        spans {takaful.headline.activeCountries} countries | All values in US$
        billions unless noted
      </div>
    </div>
  );
...
function TabOtherIFIs() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div
        className="animate-in fade-in slide-in-from-top-3 duration-500 rounded-xl border p-4"
        style={{
          borderColor: `${COLORS.purple}30`,
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-start gap-3">
            <div
              ...
              style={{ backgroundColor: `${COLORS.purple}12` }}
            >
              <Landmark className="h-5 w-5" style={{ color: COLORS.purple }} />
            </div>
            <div className="text-sm" style={{ color: COLORS.purple }}>
              Other IFIs maintain the most consistent growth trajectory in
              Islamic finance, acting as a stabilizing layer through global rate
              shocks and post-COVID restructuring.
            </div>
          </div>
          <div className="text-right text-sm font-bold text-gray-900">
            {otherIFIs.headline.stabilityWindowStart} to{" "}
            {otherIFIs.headline.stabilityWindowEnd} in 6 years
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <SectionCard
          title="Other IFI Asset Trend (2018-2029)"
          className="lg:col-span-3"
        >
          <div className="relative h-[320px]">
            ...
            <div
              className="pointer-events-none absolute left-[44%] top-[63%] rounded-full px-2 py-1 text-[11px] animate-in fade-in duration-500"
              style={{
                animationDelay: "1000ms",
                backgroundColor: `${COLORS.controlledRed}10`,
                color: COLORS.controlledRed,
              }}
            >
              Dip reflects post-COVID institutional restructuring
            </div>
            <div
              className="pointer-events-none absolute right-[24%] top-[26%] text-xs animate-in fade-in duration-500"
              style={{ animationDelay: "1400ms", color: COLORS.emerald }}
            >
              Recovery path
            </div>
          </div>
        ...
        >
          ...
          >
            GCC holds US${otherIFIs.headline.gccValue}bn (
            {otherIFIs.headline.gccShare}), followed by Southeast Asia at US$
      ...
      <SectionCard title="Top 10 Countries by Other IFI Assets (US$bn, 2024)">
        ...
        <div className="mt-4 rounded-xl border border-purple-200 bg-gray-100 p-4 text-xs leading-relaxed text-gray-500">
          Pakistan's OIFI sector is dominated by mudaraba companies, while
          Switzerland stands out as the leading non-OIC institutional booking
          center for Islamic development finance.
        </div>
      </SectionCard>
      ...
      <div className="text-center text-xs text-gray-400">
        Source: ICD-LSEG Islamic Finance Development Report 2025 | Other IFIs
        include development finance, mudaraba, leasing and microfinance
        institutions | All values in US$ billions unless noted
      </div>
    </div>
  );
}
...
function TabSukuk() {
  ...
  const SukukGrowthTooltip = ({
    ...
    payload?: ReadonlyArray<{
      value?: number;
      payload?: { year?: string; isMilestone?: boolean; isProjected?: boolean };
    }>;
    label?: string;
  }>) => {
    if (!active || !payload?.length || typeof payload[0]?.value !== "number") {
    ...
    return (
      <div
        className="rounded-xl border bg-white px-3 py-2 text-xs text-gray-800 shadow-xl"
      ...
      >
        ...
        {item?.isMilestone && (
          <div className="mt-1" style={{ color: COLORS.gold }}>
            Historic trillion milestone reached
          </div>
        )}
        {item?.isProjected && (
          <div className="mt-2">
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      >
        <div className="flex flex-col items-center text-center w-full">
          <Trophy
            className="h-14 w-14 animate-bounce [animation-iteration-count:1]"
            style={{ color: COLORS.gold }}
          />
          <p
            className="font-black text-2xl tracking-widest uppercase mt-3"
            style={{ color: COLORS.gold }}
          >
            Historic Milestone Achieved
          </p>
          <p className="text-lg mt-1" style={{ color: "#667085" }}>
            Global Sukuk Market Crosses
          </p>
          <p
            className="font-black text-5xl"
            style={{
              color: "#101828",
              textShadow: `0 0 18px ${COLORS.teal}30`,
            }}
          >
            {milestoneLabel}
          </p>
          <p className="text-base mt-1" style={{ color: "#667085" }}>
            in Outstanding Value - 2024
          </p>
          <p className="text-sm mt-2" style={{ color: "#98A2B3" }}>
            Global issuance rose {sukuk.headline.globalIssuanceGrowth} to US$
            {sukuk.headline.globalIssuance2024}bn in 2024 · Governments account
            for {sukuk.headline.govtShareOfIssuance} of issuances
          </p>
          ...
          <div className="mt-4 grid w-full max-w-4xl grid-cols-1 gap-2 sm:grid-cols-3">
            ...
            <div
              className="rounded-lg border bg-white/80 px-3 py-2 text-sm"
              style={{ borderColor: "#E9E5E5", color: "#101828" }}
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <SectionCard
          title="Sukuk Outstanding Value Growth - The Road to US$1 Trillion"
          className="lg:col-span-3"
        >
          <div className="relative h-[360px]">
            <ResponsiveContainer width="100%" height="100%" minWidth={0}>
              <BarChart
                data={sukukBarData}
                margin={{ top: 30, right: 18, left: 6, bottom: 8 }}
              >
                <defs>
                  <linearGradient
                    id="sukukGradient"
            ...
            <div
              className="pointer-events-none absolute left-[68%] top-[10%] rounded-full px-2 py-1 text-[11px] font-bold"
              style={{
            ...
            <div
              className="pointer-events-none absolute right-[2%] top-[0%] rounded-full px-2 py-1 text-[11px]"
              style={{
                backgroundColor: `${COLORS.gold}15`,
                color: COLORS.gold,
              }}
      ...
      <SectionCard title="Top 10 Countries by Sukuk Outstanding (US$bn, 2024)">
              ...
              >
                ...
                {country.country === "Malaysia" && (
                  <div className="mt-2 space-y-1 text-right">
                    ...
                    <div className="text-xs" style={{ color: COLORS.teal }}>
                      Malaysia accounts for {sukuk.headline.malaysiaGlobalShare}{" "}
                      of all global sukuk outstanding
                    </div>
                  </div>
                )}
                ...
                {country.country === "Saudi Arabia" && (
                  <div className="mt-2 space-y-1 text-right">
                    ...
                    >
                      🥈 GCC Leader - US${sukuk.headline.saudiIssuance2024}bn
                      issued in 2024 alone
                    </span>
                    <div className="text-xs" style={{ color: COLORS.teal }}>
                      {sukuk.headline.saudiIssuanceGrowth} surge in 2024
                      issuance driven by Vision 2030 financing
                    </div>
                  </div>
                )}
                ...
                {country.country === "Indonesia" && (
                  <div
                    ...
                    style={{ color: COLORS.purple }}
                  >
                    🏆 World's #1 Green Sukuk Issuer
                  </div>
                )}

                {country.country === "UAE" && (
                  <div className="mt-2 text-right text-xs text-gray-600">
                    US$100bn outstanding - major hub for ESG sukuk
                  </div>
                )}

                {index === 3 && (
                  <div className="mt-4 border-t border-gray-200 pt-2 text-xs text-gray-400">
        ...
        <div className="mt-4 rounded-xl border border-cyan-200 bg-gray-100 p-4 text-xs leading-relaxed text-gray-500">
          💡 Sukuk Market Intelligence: {sukuk.headline.globalMaturityBy2030} of
          outstanding sukuk mature by 2030, with US$
          {sukuk.headline.maturingIn2025}bn due in 2025 alone. Saudi Aramco,
          PIF, and Saudi Electricity Company were major 2024 issuers. AAOIFI's
          Standard 62 (delayed to 2026) will reshape sukuk structures by
          requiring actual legal asset transfer.
        </div>
      </SectionCard>
      ...
      <SectionCard title="2024 Sukuk Issuance Highlights">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div
            className="animate-in fade-in slide-in-from-bottom-4 duration-500 rounded-xl border p-5 transition-colors"
            style={{
              animationDelay: "0ms",
              borderColor: COLORS.cardBorder,
              backgroundColor: COLORS.cardTint,
          ...
          >
            ...
            <div className="text-2xl font-bold" style={{ color: COLORS.gold }}>
              US${sukuk.headline.saudiIssuance2024}bn
            </div>
            <div className="mt-1 text-xs text-gray-600">
              Saudi Arabia 2024 Issuance
            </div>
            <p className="mt-3 text-xs leading-relaxed text-gray-500">
              {sukuk.headline.saudiIssuanceGrowth} surge from 2023. Saudi
              government raised US$42.3bn including US$17bn for debt
              refinancing.
            </p>
            <div className="mt-4">
              ...
              <div className="h-2 overflow-hidden rounded-full bg-white">
                <div
                  className="h-full rounded-full"
                  style={{
                    width: `${(sukuk.headline.saudiIssuance2024 / sukuk.headline.globalIssuance2024) * 100}%`,
          ...
          >
            ...
            <div className="text-2xl font-bold" style={{ color: COLORS.teal }}>
              {sukuk.headline.govtShareOfIssuance}
            </div>
            <div className="mt-1 text-xs text-gray-600">
              Government Share of Issuance
            </div>
            <p className="mt-3 text-xs leading-relaxed text-gray-500">
              Sovereigns dominate driven by fiscal deficits and refinancing
              needs. {corporateShare}% from corporates and agencies.
            </p>
            <div className="mt-4 flex h-2 overflow-hidden rounded-full bg-white">
              <div
                className="h-full"
                style={{ width: `${govtShare}%`, backgroundColor: COLORS.teal }}
              />
              <div
                className="h-full bg-gray-300"
                style={{ width: `${corporateShare}%` }}
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="text-2xl font-bold" style={{ color: COLORS.gold }}>
              US${sukuk.headline.maturingIn2025}bn
            </div>
            <div className="mt-1 text-xs text-gray-600">
              Sukuk Maturing in 2025
            </div>
            <p className="mt-3 text-xs leading-relaxed text-gray-500">
              {sukuk.headline.globalMaturityBy2030} of outstanding sukuk mature
              by 2030. Expected to keep issuance elevated as refinancing needs
              grow.
            </p>
            <div className="mt-4 flex items-center gap-2">
              <div className="h-2 flex-1 overflow-hidden rounded-full bg-white">
                <div
                  ...
                  style={{
                    width: `${(sukuk.headline.maturingIn2025 / sukuk.headline.globalIssuance2024) * 100}%`,
                    backgroundColor: COLORS.gold,
                  }}
                />
              </div>
              <span className="text-[11px]" style={{ color: COLORS.gold }}>
                Elevated refinancing cycle
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="text-center text-xs text-gray-400">
        Source: ICD-LSEG Islamic Finance Development Report 2025 | Sukuk are the
        second-largest Islamic finance sector and crossed US$1 trillion in 2024
...
function TabIslamicFunds() {
  ...
  function FundsGrowthTooltip({
    ...
    return (
      ...
      >
        ...
        <div>{formatUsdValue(item.value)}</div>
        {label === "2022" && (
          <div className="mt-1 italic" style={{ color: COLORS.controlledRed }}>
            (Global interest rate hike impact)
          </div>
        )}
        {item.payload?.projected && (
          <div className="mt-2">
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-wrap gap-3">
        <BankingInsightPill
          className="border-[#7C3AED]/20 bg-[#7C3AED]/8 text-[#7C3AED]"
          delay={0}
        >
        ...
        <BankingInsightPill
          ...
          delay={120}
        >
          🇺🇸 United States in top 10 - US${funds.headline.usValue}bn in Islamic
          AuM
        </BankingInsightPill>
        <BankingInsightPill
          className="border-[#D4A017]/20 bg-[#D4A017]/8 text-[#D4A017]"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <SectionCard
          title="Islamic Funds AuM Growth — Resilience After 2022 Dip"
          className="lg:col-span-3"
        >
          <div className="relative h-[340px]">
            <p className="sr-only">
              Islamic Funds AuM growth chart from 2018 to projected 2029
            </p>
            <ResponsiveContainer width="100%" height="100%" minWidth={0}>
              <AreaChart
                data={growthData}
              ...
              >
                ...
                <YAxis
                  ...
                  axisLine={false}
                  tickLine={false}
                  tickFormatter={(value: number) => `${value}bn`}
                />
                <RechartsTooltip
            ...
            <div
              className="pointer-events-none absolute left-[38%] top-[20%] text-xs"
              style={{ color: COLORS.controlledRed }}
            >
              📉 -US${funds.headline.dipFrom2021}bn (Global rate cycle impact)
            </div>
            <div
              className="pointer-events-none absolute left-[56%] top-[12%] text-xs"
              style={{ color: COLORS.emerald }}
            >
              ↗ Recovery: +US${funds.headline.recoveryFrom2022}bn (2022→2024)
            </div>
            <div
              className="pointer-events-none absolute right-[2%] top-[4%] text-xs"
              style={{ color: COLORS.gold }}
            >
      ...
      <SectionCard title="Top 10 Countries by Islamic Funds AuM (US$bn, 2024)">
            ...
            >
              ...
              {country.country === "Iran" && (
                <div className="mt-2 text-right">
                  ...
                  >
                    🥇 Largest AuM — Domestic market-driven
                  </span>
                </div>
              )}
              {country.country === "UAE" && (
              ...
              {country.country === "United Kingdom" && (
                <>
                  <div className="mt-2 text-right">
                    ...
                    >
                      🥉 🌍 Highest-ranked non-OIC country globally
                    </span>
                  </div>
                  <div
                    className="mx-4 mt-1 rounded-lg border p-2 text-xs"
                    style={{
                  ...
                  >
                    The UK's US${funds.headline.ukValue}bn Islamic fund market
                    is driven by Shariah-compliant pension funds, ETFs, and the
                    growing Muslim investor base accessing HSBC Islamic Global
                    Equity Index.
                  </div>
                </>
              )}
              {country.country === "Malaysia" && (
                <div className="mt-2 text-right">
                  ...
                  >
                    4️⃣ SEA Hub — Largest Islamic fund market in Southeast Asia
                  </span>
                </div>
              )}
              {country.country === "United States" && (
                <div className="mt-2 text-right">
                  ...
                  >
                    7️⃣ 🇺🇸 Non-OIC — Growing ESG-Islamic fund overlap
                  </span>
                </div>
              )}
              ...
              {index === 2 && (
                <div className="mt-3 border-t border-gray-200 pt-2 text-xs text-gray-400">
                  Below: Emerging Islamic fund markets
                </div>
              )}
            </div>
          ))}
        ...
        <div className="mt-4 rounded-xl border border-purple-200 bg-gray-100 p-4 text-xs leading-relaxed text-gray-500">
          ...
          bn) represent just {funds.headline.sukukFundsShare} of Islamic fund
          value despite {funds.headline.sukukFundsGrowth} growth in 2024. Nine
          new Islamic ETFs launched across 8 countries in 2024 including South
          Africa's first. Kazakhstan and Hong Kong launched Islamic ETFs in
          early 2025. ESG Islamic funds outstanding:{" "}
          {funds.headline.esgFundsValue}.
        </div>
      </SectionCard>
        ...
        <div className="flex gap-4 overflow-x-auto pb-2">
          {funds.innovation.map((item, index) => (
            ...
            >
              ...
              <p className="mt-2 min-h-[86px] text-xs leading-relaxed text-gray-500">
                {item.description}
              </p>
              <div
                className={`mt-3 inline-flex rounded-full border px-2.5 py-1 text-[11px] ${item.badgeClassName}`}
              >
                {item.badge}
              </div>
            </div>
      ...
      <div className="text-center text-xs text-gray-400">
        Source: ICD-LSEG Islamic Finance Development Report 2025 | Islamic Funds
        data spans ETFs, ESG and multi-asset vehicles across global markets |
        All values in US$ billions unless noted
      </div>
    </div>
  );
