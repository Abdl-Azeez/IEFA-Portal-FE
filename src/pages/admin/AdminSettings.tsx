            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-lg border border-gray-200 text-sm px-3 py-2 bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#D52B1E]/20 resize-none"
                />
              </div>
