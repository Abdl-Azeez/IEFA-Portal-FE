  ...
  return (
    ...
    >
      <motion.div variants={itemVariants}>
        <h1 className="text-3xl font-bold tracking-tight text-[#000000]">Support</h1>
        <p className="mt-2 text-[#737692]">
          If something feels unclear or you&apos;d like to suggest a feature, this is where you&apos;ll be
          able to reach the IEFA team.
        </p>
      </motion.div>
          ...
          <Card className="transition-all duration-300 hover:shadow-xl">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription className="text-[#737692]">
                    This is not a live form yet, but it shows the structure we can wire into your actual
                    support inbox or ticketing tool later.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-[#000000]">Email</label>
                  <Input
                    type="email"
                ...
                <div>
                  <label className="text-sm font-medium text-[#000000]">Topic</label>
            ...
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription className="text-[#737692]">
                    You could link to quick-start guides, FAQs, and video walkthroughs from here.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full border-[#D52B1E] text-[#D52B1E] hover:bg-[#D52B1E] hover:text-white">
                Browse FAQs
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 border-primary/20">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-[#000000]">Fast feedback loop</CardTitle>
              </div>
              <CardDescription className="text-[#737692]">
                The fastest way to make this portal better is to tell us what&apos;s missing or what
                feels confusing. This page is designed to encourage that.
              </CardDescription>
            </CardHeader>
          </Card>
        </motion.div>
